...
stream-offer lifecycle explanations and grouped audit summaries. The latest
released package and CLI version still report `darwin-sim 1.3.0`.
...
The current planning-branch scenario set is contiguous through `063`.
